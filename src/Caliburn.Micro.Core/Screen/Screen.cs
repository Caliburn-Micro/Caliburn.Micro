...
public class Screen : ViewAware, IScreen, IChild {
    ...
    /// </summary>
    public virtual event AsyncEventHandler<ActivationEventArgs> Activated
        = (sender, e) => Task.FromResult(true);
    ...
    /// </summary>
    public virtual event AsyncEventHandler<DeactivationEventArgs> Deactivated
        = (sender, e) => Task.FromResult(true);

    /// <summary>
    /// Gets a value indicating whether or not this instance is currently initialized.
    ...
    /// <summary>
    /// Gets a value indicating whether or not this instance is currently active.
    /// Virtualized in order to help with document oriented view models.
    /// </summary>
