    ...
    public class PackageList : List<PackageModel> {
        public PackageList() {
            Add(new PackageModel {
                ...
                Tags = "Silverlight WPF WP7 WP71 SL4 SL Phone IoC DI Container Mono Unity3d WinRT",
                Content = {
            ...
            Add(new PackageModel {
                ...
                Tags = "Silverlight WPF WP7 WP71 SL4 SL Phone EA PubSub EventAggregator Messaging Messenger Publish Subscribe Event Mono Unity3d WinRT",
                Content = {
                    "../../../Caliburn.Micro.Silverlight/ExtensionMethods.cs",
            ...
            Add(new PackageModel {
                ...
                Tags = "Silverlight WPF WP7 WP71 SL4 SL Phone INPC INotifyPropertyChanged MVVM",
                Content = {
                    "../../../Caliburn.Micro.Silverlight/ExtensionMethods.cs",
