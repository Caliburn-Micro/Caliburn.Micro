...
namespace Caliburn.Micro.Core.Tests {
    public class SimpleContainer_Getting_ASingle_Instance_Tests {
        [Fact]
        ...
        [Fact]
        public void Null_is_returned_when_no_instance_is_found() => Assert.Null(new SimpleContainer().GetInstance(typeof(object), null));
    }
}
