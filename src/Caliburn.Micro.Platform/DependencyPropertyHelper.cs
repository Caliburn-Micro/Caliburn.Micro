    ...
    public static class DependencyPropertyHelper {
        ...
        public static DependencyProperty RegisterAttached(string name, Type propertyType, Type ownerType, object defaultValue = null, PropertyChangedCallback propertyChangedCallback = null) =>
#if XFORMS
            DependencyProperty.CreateAttached(
                name,
                propertyType,
                ownerType,
                defaultValue,
            ...
            DependencyProperty.CreateAttached(
                ...
                ownerType,
                defaultValue,
                propertyChanged: (obj, oldValue, newValue) => propertyChangedCallback?.Invoke(obj, new DependencyPropertyChangedEventArgs(newValue, oldValue, null)));
#else
