...
namespace Caliburn.Micro.Xamarin.Forms {
    ...
    public static class ConventionManager {
        private static readonly ILog Log
            = LogManager.GetLog(typeof(ConventionManager));
        ...
        /// <summary>
        /// Gets or sets func to create a binding and sets it on the element, applying the appropriate conventions.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets func to apply the appropriate binding mode to the binding.
        /// </summary>
