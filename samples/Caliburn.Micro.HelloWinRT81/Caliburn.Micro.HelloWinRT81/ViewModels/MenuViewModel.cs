...
namespace Caliburn.Micro.WinRT.Sample.ViewModels
{
    public class MenuViewModel : ViewModelBase
    {
        ...
        protected override void OnInitialize()
        {
            ...
            Samples.Add(new SampleViewModel { Title = "Conventions (8.1)", Subtitle = "Binding view model properties to your view with the 8.1 controls.", ViewModelType = typeof(ConventionsViewModel) });
            Samples.Add(new SampleViewModel { Title = "Hub control (8.1)", Subtitle = "Binding view model properties to your view.", ViewModelType = typeof(HubViewModel) });
